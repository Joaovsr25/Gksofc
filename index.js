...
const { gksbr } = require('./menus/gksbr')
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD JvBoots BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] JvBoots? Este é um recurso especial para o JvBoots ❌',
					ownerB: '[❗] JvBoots? Este é um recurso especial para o JvBoots ❌',
			...
			switch(command) {
				...
				case '?':
				case 'comandos':
					costum(menu(pushname, prefix, groupName ), text, tescuk, cr)
break
				case 'info':
					me = client.user
